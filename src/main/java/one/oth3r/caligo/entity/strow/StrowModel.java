...
public class StrowModel extends EntityModel<StrowEntityRenderState> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData body = root.addChild("body", ModelPartBuilder.create(), ModelTransform.origin(0.0F, -2.0F, 0.0F));
		...
		ModelPartData head = body.addChild("head", ModelPartBuilder.create().uv(12, 0).cuboid(-1.05F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, new Dilation(0.0F))
				.uv(9, 0).cuboid(-3.05F, -1.75F, -0.5F, 2.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.origin(-2.0F, -5.0F, 0.0F));

		ModelPartData wing0 = body.addChild("wing0", ModelPartBuilder.create(), ModelTransform.origin(-1.85F, -4.4F, 1.5F));
		...
		ModelPartData wing1 = body.addChild("wing1", ModelPartBuilder.create(), ModelTransform.origin(-1.85F, -4.4F, -1.5F));
		...
		ModelPartData tail = body.addChild("tail", ModelPartBuilder.create(), ModelTransform.origin(0.75F, -0.9F, 0.0F));
		...
		ModelPartData leg0 = root.addChild("leg0", ModelPartBuilder.create().uv(0, 13).cuboid(-0.5F, 0.0F, -0.5F, 1.0F, 3.0F, 1.0F, new Dilation(0.0F)), ModelTransform.origin(-0.5F, -3.0F, -1.0F));

		ModelPartData leg1 = root.addChild("leg1", ModelPartBuilder.create().uv(4, 13).cuboid(-0.5F, 0.0F, -0.5F, 1.0F, 3.0F, 1.0F, new Dilation(0.0F)), ModelTransform.origin(-0.5F, -3.0F, 1.0F));
	...
	public void setAngles(StrowEntityRenderState state) {
		...
		animateWalking(StrowAnimations.RUN, state.limbSwingAnimationProgress, state.limbSwingAmplitude, 2f, 2.5f);
