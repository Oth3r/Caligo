...
public class StrowRenderer extends MobEntityRenderer<StrowEntity, StrowModel<StrowEntity>> {
    private static final Identifier TEXTURE = new Identifier(Caligo.MOD_ID, "textures/entity/strow/strow.png");
//    private static final Identifier TEXTURE_ANGRY = new Identifier(SpookieTest.MOD_ID, "textures/entity/strow/strow_angry.png");
