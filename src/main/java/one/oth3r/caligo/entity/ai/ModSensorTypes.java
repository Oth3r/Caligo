...
public class ModSensorTypes {
    public static final SensorType<CoppiceSpecificSensor> COPPICE_SPECIFIC_SENSOR = registerSensor("coppice_specific_sensor", CoppiceSpecificSensor::new);
    public static final SensorType<TemptationsSensor> COPPICE_TEMPTATIONS = registerSensor("coppice_temptations",
